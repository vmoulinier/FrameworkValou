...
<div class="row">
    ...
    <div class="col-2">
        <button class="btn btn-success" data-toggle="modal" data-target="#add"><i class="fas fa-plus"></i> Ajouter</button>
    </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <input type="text" name="add_fr" id="add_fr" class="form-control">
                    <br />

                    <label for="en" class="bold">Traduction anglaise</label>
                    <input type="text" name="add_en" id="add_en" class="form-control">
                    <br />
                    <p id="response" class="green display">Traduction enregistrées</p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Fermer</button>
                    <button type="button" class="btn btn-primary" id="add_save">Sauvegarder</button>
                </div>
            </div>
        </div>
    </div>
